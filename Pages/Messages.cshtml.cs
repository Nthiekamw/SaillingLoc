...
namespace SaillingLoc.Pages
{
    public class MessagesModel : PageModel
    {
        ...
        public async Task OnGetAsync()
        {
            ...
            if (currentUser == null)
            {
                // Redirection vers la page de connexion avec retour à la messagerie
                Response.Redirect("/Identity/Account/Login?returnUrl=/Messages");
                return;
            }

            // Récupérer tous les messages liés à cet utilisateur (envoyés ou reçus)
            ...
            // Préparer la liste des utilisateurs pour le formulaire d'envoi
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Redirection vers la messagerie après envoi
