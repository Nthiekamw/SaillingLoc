        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availabilities_Boats_BoatId",
                        column: x => x.BoatId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoatEquipments_Boats_BoatId",
                        column: x => x.BoatId,
                        principalTable: "Boats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoatPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoatPhotos_Boats_BoatId",
                        column: x => x.BoatId,
                        principalTable: "Boats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerSignature = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TenantSignature = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_BoatId",
                table: "Availabilities",
                column: "BoatId");

            migrationBuilder.CreateIndex(
                name: "IX_BoatEquipments_BoatId",
                table: "BoatEquipments",
                column: "BoatId");

            migrationBuilder.CreateIndex(
                name: "IX_BoatPhotos_BoatId",
                table: "BoatPhotos",
                column: "BoatId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_BoatOwnerId",
                schema: "dbo",
                table: "Reservations",
                column: "BoatOwnerId");
