...
{
    // Alias pour éviter l'ambiguïté avec Microsoft.AspNetCore.Mvc.SignInResult
    ...
    public class FakeUserStore : IUserStore<User>
    {
        ...
        public Task<string> GetUserIdAsync(User user, CancellationToken cancellationToken) => Task.FromResult(user.UserName);
    ...
    public class LoginModelTests
    {
        ...
        public async Task OnPostAsync_WithValidCredentials_ShouldRedirectToIndex()
        {
            ...
            (result as RedirectToPageResult)!.PageName.Should().Be("/Index");
        }
        ...
        public async Task OnPostAsync_WithInvalidPassword_ShouldReturnPageResult()
        {
            ...
            result.Should().BeAssignableTo<PageResult>(); // reste sur la page login
        }
